...
class ApiKeysHelper
{
	...
	public static function sessionOnly(): array
	{
		return [
			...
			'mantle2.activities.staged.list',
			'mantle2.activities.staged.approve',
			'mantle2.activities.staged.deny',
			'mantle2.admin.verified_publishers',
			'mantle2.admin.verified_publishers.patch',
			'mantle2.motd.set',
	...
	public static function routeScopes(): array
	{
		return [
			...
			'mantle2.activities.stage' => ApiKeyScope::ACTIVITIES_WRITE_STAGE,
			'mantle2.activities.staged.mine' => ApiKeyScope::ACTIVITIES_READ_STAGE,
			'mantle2.activities.staged.get' => ApiKeyScope::ACTIVITIES_READ_STAGE,
			'mantle2.activities.staged.withdraw' => ApiKeyScope::ACTIVITIES_WRITE_STAGE,
			'mantle2.users.current.verified_publisher.get' => ApiKeyScope::USER_READ_PRIVATE,
			'mantle2.users.current.verified_publisher.apply' => ApiKeyScope::USER_EDIT_PUBLISHER,
